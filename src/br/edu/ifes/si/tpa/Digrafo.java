...
public class Digrafo {
    ...
    private Map<Integer, Integer> autorPorArtigo  = new HashMap<Integer, Integer>(); //Armazenar qual autor de cada artigo
    ...
    public Digrafo(In in) {
        ...
        for (int x = 0; x < V; x++){
            autorPorArtigo.put(in.readInt(), in.readInt());
            //in.readInt();
            //in.readInt(); //Ler o proximo inteiro
        }
    ...
    public Map<Integer, Integer> getAutores(){
        return autorPorArtigo;
    }
